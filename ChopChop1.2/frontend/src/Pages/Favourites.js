...
class Favourites extends Component {
  ...
  render() {
    ...
    return (
      <div style={{ paddingTop: "200px", fontFamily: "Courier New", fontWeight: "bold", fontSize: "50px"}}>
        <div id="wrapper">
          <header>
            <div id="page-banner">
              <h1 class="title" style={styles.LogInOut}>Favourites</h1>
          ...
          <div id="book-list">
            <h2 class="title" style={styles.LogInOut}>Recently Liked:</h2>
